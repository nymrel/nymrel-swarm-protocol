...
export type MissionState = 'INIT' | 'ACTIVE' | 'TRANSFER_REQUESTED' | 'TRANSFERRED' | 'RECOVERING' | 'TERMINATED';
export type HealthState = 'HEALTHY' | 'SUSPECT' | 'STALE' | 'LEASE_EXPIRED' | 'RECOVERING' | 'RECONCILED';
...
export interface BusEvent {
    event_id: string;
    timestamp: string;
    event_type: 'claim_acquired' | 'claim_released' | 'claim_expired' | 'claim_heartbeat' | 'message_sent' | 'message_broadcast' | 'message_delivered' | 'fencing_incremented' | 'mission_initialized' | 'mission_handover' | 'mission_recovery' | 'mission_closed';
    actor: string;
    resource?: string;
